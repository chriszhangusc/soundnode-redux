...
export const SEARCH_ARTISTS_RECEIVED = 'SEARCH_USERS_RECEIVED';
...
/* Artist Action Types */
export const START_ARTIST_FETCH = 'START_ARTIST_FETCH';
export const END_ARTIST_FETCH = 'END_ARTIST_FETCH';
export const ARTIST_RECEIVED = 'USER_RECEIVED';
export const TRACKS_RECEIVED = 'TRACKS_RECEIVED';
export const START_TRACKS_FETCH = 'START_TRACKS_FETCH';
export const END_TRACKS_FETCH = 'END_TRACKS_FETCH';

export const CHARTS_CHANGE_GENRE = 'CHARTS_CHANGE_GENRE';
export const CHARTS_REQUEST_TRACKS = 'CHARTS_REQUEST_TRACKS';
export const CHARTS_RECEIVE_TRACKS = 'CHARTS_RECEIVE_TRACKS';

/* Track Action Types */
export const TRACK_START_FETCH = 'TRACK_START_FETCH';
export const TRACK_RECEIVED = 'TRACK_RECEIVED';
export const TRACK_ARTIST_RECEIVED = 'TRACK_ARTIST_RECEIVED';
