...
const INITIAL_STATE = fromJS({
    isShown: false, isFetching: false,
...
const search = (state = INITIAL_STATE, action) => {
    switch (action.type) {
        ...
        case SEARCH_DROPDOWN_ARTISTS_RECEIVED:
            ...
            return state.set('dropdownArtists', action.payload.artistMap).merge({artistNextHref: action.payload.nextHref});
        case SEARCH_DROPDOWN_TRACKS_RECEIVED:
            return state.set('dropdownTracks', action.payload.trackMap);
        case SEARCH_RESULTS_RECEIVED:
            return state.set('searchResults', action.payload.resultMap).merge({trackNextHref: action.payload.nextHref});
